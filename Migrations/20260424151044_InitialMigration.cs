        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentReferenceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payments", x => x.SubscriptionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    ProfileId = table.Column<int>(type: "int", nullable: false),
                    ActingRating = table.Column<int>(type: "int", maxLength: 250, nullable: false),
                    StoryRating = table.Column<int>(type: "int", nullable: false),
                    ProductionRating = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_ProfileId_MovieId",
                table: "Ratings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Watchlists_ProfileId_MovieId",
                table: "Watchlists",
                columns: new[] { "ProfileId", "MovieId" },
                unique: true);
        }
